...
if __name__ == "__main__":
    ...
    train_data= utils.WindowDataset(train_data_pd[list_of_vars], window_size, 4, 3)
    train_loader = torch.utils.data.DataLoader(train_data, batch_size=32, shuffle=True)

    test_data = utils.WindowDataset(test_data_pd[list_of_vars], window_size, 4, 3)
    ...
    loss_function = utils.SpecialCrossEntropyLoss()
    optimizer = torch.optim.Adam(model.parameters(), lr=learning_rate)

    print("Training model {}...".format("rainfall"))
